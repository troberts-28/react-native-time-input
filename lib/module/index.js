...
export default function TimeInput({
  ...
  const [initialTimeParsed] = useState(() => isDuration && typeof initialValue === 'number' ? parseLocaleTimeString(durationInputConverter(initialValue)) : initialValue instanceof Date ? parseLocaleTimeString(getLocaleTimeString(initialValue, hideHours, includeSeconds, hideToggle)) : null);
