...
function TimeInput({
  ...
  const [initialTimeParsed] = (0, _react.useState)(() => !initialTime ? null : (0, _parseLocaleTimeString.default)((0, _getLocaleTimeString.default)(initialTime, hideHours, includeSeconds, hideToggle)));
