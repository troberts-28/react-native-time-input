...
function TimeInput({
  ...
  const [currentLocaleTime] = (0, _react.useState)((0, _getLocaleTimeString.default)(null, hideHours, includeSeconds));
  const [currentLocaleTimeParsed] = (0, _react.useState)((0, _parseLocaleTimeString.default)(currentLocaleTime));
  const [initialTimeParsed] = (0, _react.useState)(() => !initialTime ? null : (0, _parseLocaleTimeString.default)((0, _getLocaleTimeString.default)(initialTime, hideHours, includeSeconds)));
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    ...
    style: [(_componentStyle$input = componentStyle.input) !== null && _componentStyle$input !== void 0 ? _componentStyle$input : {}, {
      ...
      color: !isDisabled ? componentTheme.inputTextColor : 'transparent',
